  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{background: 'linear-gradient(135deg, #0d0f14 0%, #1a1e28 100%)'}}>
      <div className="w-full max-w-md rounded-lg p-8" style={{backgroundColor: '#1a1e28', border: '1px solid rgba(255, 255, 255, 0.07)'}}>
        ...
        <p className="text-[#9aa3b8] text-center mb-8">Create your account</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-[#e8eaf0] mb-2">Full Name</label>
            <div className="relative">
              <User className="absolute left-3 top-3.5 text-[#9aa3b8]" size={20} />
              <input
                type="text"
                value={name}
          ...
          <div>
            <label className="block text-sm font-medium text-[#e8eaf0] mb-2">Username</label>
            <div className="relative">
              <User className="absolute left-3 top-3.5 text-[#9aa3b8]" size={20} />
              <input
                type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-[#e8eaf0] mb-2">Email Address</label>
            <div className="relative">
          ...
          <div>
            <label className="block text-sm font-medium text-[#e8eaf0] mb-2">Role</label>
            <select
              value={role}
              onChange={(e) => setRole(e.target.value)}
              style={{backgroundColor: '#13161e', borderColor: 'rgba(255, 255, 255, 0.1)', color: '#e8eaf0'}}
              className="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#6c8cff] focus:border-[#6c8cff]"
            >
        ...
        <p className="text-center text-[#9aa3b8] mt-6">
          ...
          <Link to="/login" className="text-[#6c8cff] hover:underline font-medium">
            Sign in here
          </Link>
        </p>
      </div>
